...
struct no_os_gpio_desc	*gpio_adrv9025_resetb;
...
int32_t platform_init(void)
{
	...
	gpio_adrv9025_resetb_param.platform_ops = &xil_gpio_ops;
	gpio_adrv9025_resetb_param.extra = &xilinx_gpio_param;
	...
	gpio_adrv9025_resetb_param.platform_ops = &altera_gpio_ops;
	gpio_adrv9025_resetb_param.extra = &altera_gpio_param;
...
#endif
	status = no_os_gpio_get(&gpio_adrv9025_resetb, &gpio_adrv9025_resetb_param);
	...
	spi_param.chip_select = ADRV9025_CS;
...
int32_t platform_remove(void)
{
	...
	status = no_os_gpio_remove(gpio_adrv9025_resetb);
...
commonErr_t CMB_hardReset(uint8_t spiChipSelectIndex)
{
	...
	case ADRV9025_CS:
		reset_gpio = gpio_adrv9025_resetb;
		break;
	case AD9528_CS:
